...
import cn.data.function.MyAggFunction;
import cn.data.waremark.MyWaremake;
...
public class DataReport {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //prop.setProperty("zookeeper.connect", "192.168.1.84:2181,192.168.1.85:2181,192.168.1.86:2181");
        prop.setProperty("bootstrap.servers","192.168.1.84:9092,192.168.1.85:9092,192.168.1.86:9092");
        //prop.put("bootstrap.servers", "192.168.1.84:9092,192.168.1.85:9092,192.168.1.86:9092");
         ...
         * 窗口统计操作
         */
        SingleOutputStreamOperator<Tuple4<String, String, String, Long>> resultData = filterData.assignTimestampsAndWatermarks(new MyWaremake())
                .keyBy(1, 2)
        ...
        //把迟到的数据存储到kafka中
        String outTopic = "number";
        Properties outprop = new Properties();
        //outprop.setProperty("zookeeper.connect", "192.168.1.84:2181,192.168.1.85:2181,192.168.1.86:2181");

        outprop.setProperty("bootstrap.servers","192.168.1.84:9092,192.168.1.85:9092,192.168.1.86:9092");
       // outprop.setProperty("bootstrap.servers", "hadoop01:9092,hadoop02:9092,hadoop03:9092");
        ...
        httpHosts.add(new HttpHost("192.168.1.87", 9200, "http"));
